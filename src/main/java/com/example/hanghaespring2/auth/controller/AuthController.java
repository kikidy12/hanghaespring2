...
public class AuthController {
    ...
    @SecurityRequirements()
    public ResponseDto withdrawal(@Parameter(hidden = true) @AuthenticationPrincipal CustomUserDetail userDetail) {
        this.authService.withdrawal(userDetail.getUser());
        return ResponseDto.of(HttpStatus.OK, "회원탈퇴 성공");
    }
}
